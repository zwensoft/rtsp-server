 ...
 * handler after {@link RtspObjectDecoder} in the {@link ChannelPipeline}:
 * <pre>
 * {@link ChannelPipeline} p = ...;
 * ...
 * p.addLast("encoder", new {@link RtspResponseEncoder}());
 * p.addLast("decoder", new {@link RtspRequestDecoder}());
 * p.addLast("aggregator", <b>new {@link RtspObjectAggregator}(1048576)</b>);
 * ...
 * p.addLast("handler", new HttpRequestHandler());
 * </pre>
 * Be aware that you need to have the {@link HttpResponseEncoder} or {@link HttpRequestEncoder}
 * before the {@link RtspObjectAggregator} in the {@link ChannelPipeline}.
 */
public class RtspObjectAggregator extends MessageToMessageDecoder<HttpObject> {
     ...
     */
    public RtspObjectAggregator(int maxContentLength) {
     ...
     */
    public RtspObjectAggregator(int maxContentLength, boolean closeOnExpectationFailed) {
    ...
    protected void decode(final ChannelHandlerContext ctx, HttpObject msg, List<Object> out) throws Exception {
        ...
        } else if (msg instanceof InterleavedFrame){
    ...
    private static final class AggregatedFullHttpRequest extends AggregatedFullHttpMessage implements FullHttpRequest {
        ...
        public String toString() {
            return RtspMessageUtil.appendFullRequest(new StringBuilder(256), this).toString();
        }
    }
    ...
    private static final class AggregatedFullHttpResponse extends AggregatedFullHttpMessage
        ...
        @Override
        public String toString() {
            return RtspMessageUtil.appendFullResponse(new StringBuilder(256), this).toString();
        }
    }
}
