...
public abstract class AbstractRTCPSession {
     ...
     */
    public abstract void wakeSenderThread(long ssrc) ;
     ...
     */
    public synchronized void updateAvgPacket(int length) {
     ...
     * @param aPkt 
     */
    protected synchronized void addToAppQueue(long targetSsrc,
                                                 RtcpPktAPP aPkt) {
     ...
     */
    public synchronized RtcpPktAPP[] getFromAppQueue(long targetSsrc) {		
    	if(this.appQueue == null)
    		return null;
    ...
    public boolean fbAllowEarly() {
        return fbAllowEarly;
    }
    
    public void fbAllowEarly(boolean fbAllowEarly) {
        this.fbAllowEarly = fbAllowEarly;
    }
    public long prevTime() {
        return prevTime;
    }
    
    public void nextDelay(int nextDelay) {
